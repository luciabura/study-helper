...
class Data:
    ...
    def add_utterances(self, utterances, already_parsed=False, utterances_speaker=None, speakers_names=None):
        '''
        ...
        if isinstance(utterances, string_types) and not already_parsed:
